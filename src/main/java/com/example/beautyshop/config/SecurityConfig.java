package com.example.beautyshop.config;

import com.example.beautyshop.services.PersonDetailsService;
...
public class SecurityConfig{
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        ...
        http
                .authorizeHttpRequests() // указываем что все страницы защищены аутентификацией
